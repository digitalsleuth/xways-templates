template ".LNK FILE Record (non-Unicode)"
...
begin
   ...
   binary[1] "display flags"
	...
	IfEqual D$ 1
		int16 	"Length_Desc$"
		char[Length_Desc$] "Descriptor String"
	Endif
	
	IfEqual RP 1
		int16 	"Length_RelPath$"
		char[Length_RelPath$] "Relative Path String"
	Endif
	
	IfEqual WD 1
		int16 	"Length_WDPath$"
		char[Length_WDPath$] "Working Directory String"
	Endif
	
	IfEqual CL 1
		int16 	"Length_CMDLINE$"
		char[Length_CMDLINE$] "Command Line String"
	Endif
	
	IfEqual CI 1
		int16 	"Length_Icon$"
		char[Length_Icon$] "Icon String"
	Endif
end
